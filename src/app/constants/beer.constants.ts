export const BEER_URL = 'https://api.punkapi.com/v2/beers';

export const BEER_FILTER_PARAMS = ['beer_name', 'yeast', 'hops', 'malt', 'food']

// To avoid rate limits while developing
